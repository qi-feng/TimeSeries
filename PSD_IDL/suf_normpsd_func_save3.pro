...
print,'a sample of sim psd before scaling',PSDsim[1,0:20,1]

simnorm=X.simnorm
PSDsim[1,*,*]=PSDsim[1,*,*]*simnorm

print,'same sample of sim psd after scaling',PSDsim[1,0:20,1]

print,'same sample of obs psd ',realPSD[1,0:20]


print,'now rms of the sim is: ',sigma(PSDsim[1,1,*]),mean(PSDsim[1,1,*]),sigma(PSDsim[1,1,*])/mean(PSDsim[1,1,*])
print,'now rms of the obs is: ',sigma(realPSD[1,*]),mean(realPSD[1,*]),sigma(realPSD[1,*])/mean(realPSD[1,*])
