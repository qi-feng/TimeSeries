...
readcol,fname+'.dat',freq,hs1,hs2,hs3,hs4
hstotal=hs1+hs2+hs3+hs4
...
plot,freq,hstotal,xrange=[min(freq)*0.5,max(freq)*2] ,yrange=[min(hstotal)*0.2,max(hstotal)*2],psym=8,/xlog,/ylog,xstyle=3,ystyle=3,thick=5,font=0,xtitle='!17Freq (Hz)',ytitle='!17Marginal Hilbert spectrum'; color=Orange,ERRCOLOR=Orange
