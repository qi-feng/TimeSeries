...
set_plot, 'ps'
device,filename='omf_'+arg_arr[0]+'_suf.eps', /encapsulated, xsize=8 ,ysize=5,/inches,/color,bits_per_pixel=8
...
device, /close_file
device,filename='omf_'+arg_arr[0]+'_PSD.eps', /encapsulated, xsize=8 ,ysize=5,/inches,/color,bits_per_pixel=8
...
openw,lun,'omf_'+arg_arr[0]+'_PSD.dat',/get_lun
printf,lun,outPSD
Free_lun,lun
