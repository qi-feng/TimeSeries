...
FUNCTION LWA_logrebin_func, realtime, realflux, binwidth, binratio,beta
...
VPadfreq_log=alog10(VPadfreq)
VPadpsdrebin=binner(VPadfreq_log,VPadpsd,binsize=0.1)
freqFunc_log=alog10(freqFunc)
psdFuncrebin=binner(freqFunc_log,psdFunc,binsize=0.1)
...
outstruct = {                  $
       ...
       srt: trebin,               $
       srx: xrebin,               $
       srFreq: psdFuncrebin.xmean,          $
       srPSD: psdFuncrebin.ymean,            $
       realFreq: VPadpsdrebin.xmean,         $
       realPSD: VPadpsdrebin.ymean,         $
       drealPSD: VPadpsdrebin.yerr}
