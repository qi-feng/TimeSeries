...
set_plot, 'ps'
device,filename='SuF_'+arg_arr[0]+'test.eps', /encapsulated, xsize=8 ,ysize=5,/inches,/color,bits_per_pixel=8
...
device, /close_file
device,filename='PSD_'+arg_arr[0]+'test.eps', /encapsulated, xsize=8 ,ysize=5,/inches,/color,bits_per_pixel=8
...
ploterror,sufoutstruct.realFreqrebin , sufoutstruct.realPSDrebin, sufoutstruct.drealPSDrebin, psym=8,/nohat,/xlog,/ylog,font=0,charsize=1.2; color=Orange,ERRCOLOR=Orange
device, /close_file
