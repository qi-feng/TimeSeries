...
openw,lun,'simLC_N'+strtrim(string(N,format='(i)'),1)+'_beta'+strtrim(string(beta,format='(f0.2)'),1)+'m'+strtrim(string(m,format='(i)'),1)+'u'+strtrim(string(rms,format='(i)'),1)+'.dat',/get_lun
