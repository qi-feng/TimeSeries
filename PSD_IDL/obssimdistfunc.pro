;this function takes PSDsim[2,Nsim,numberofsimfreq] and realPSD[numberofsimfreq]
;computes a scaling factor that minimizes the chisq of realPSD and Nsim number of PSDs from PSDsim

function obssimdistfunc,PSDsim, realPSD, simnorm,numberofsimfreq
   nsim=50
