...
plot,frqc,psdc,psym=8,/xstyle,/xlog,/ystyle,/ylog,xrange=[min(VPadfreq)*0.9,max(VPadfreq)*5],yrange=[min(VPadpsd)*4e-1,max(VPadpsd)*1e1],xtitle='!17Frequency (Hz)',ytitle='!17RMS normalized power',font=0,xtickformat='exponent',ytickformat='exponent'
